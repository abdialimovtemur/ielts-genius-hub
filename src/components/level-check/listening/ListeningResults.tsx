// components/listening/ListeningResults.tsx
import { ListeningEvaluation } from "@/types/listening";
...
export default function ListeningResults({ evaluation, onRestart }: ListeningResultsProps) {
  return (
    <div className="min-h-screen bg-secondary/20 py-8">
      <div className="container max-w-4xl mx-auto px-4">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-primary mb-2">IELTS Listening Results</h1>
          <p className="text-muted-foreground">Your listening test has been evaluated</p>
        </div>
